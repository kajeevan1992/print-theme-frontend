...
function Field({ icon: Icon, label, type = "text", placeholder = "" }) {
  return (
    <label className="grid gap-2">
      ...
      <div className="flex h-10 items-center gap-3 rounded-xl border bg-white px-3" style={{ borderColor: "#E2E6E8" }}>
  ...
  return (
    <section className="py-8">
      <div className="mx-auto max-w-[1080px] px-4 sm:px-6 lg:px-8">
        <div className="grid overflow-hidden rounded-[22px] border bg-white shadow-[0_14px_28px_rgba(0,0,0,0.04)] lg:grid-cols-[0.88fr_1.12fr]" style={{ borderColor: "#E2E6E8" }}>
          <div className="bg-[linear-gradient(180deg,#F8FBFC,#F1F5F7)] p-7">
            ...
            <h1 className="mt-4 text-[38px] font-black leading-[0.96] tracking-[-0.05em]" style={{ color: "#121517" }}>
              Manage orders, artwork and your print account.
            </h1>
            <p className="mt-4 max-w-[520px] text-[12px] leading-6" style={{ color: "#667179" }}>
              Cleaner customer-side access for order management, artwork handoff, repeat jobs and account support.
            </p>
            ...
            <div className="mt-5 rounded-[14px] border bg-white p-4" style={{ borderColor: "#E2E6E8" }}>
              <div className="flex items-center gap-2 text-[12px] font-bold" style={{ color: "#121517" }}>
                <ShieldCheck className="h-4 w-4" style={{ color: "rgb(24, 167, 208)" }} />
                Frontend auth UX only
              </div>
              <p className="mt-2 text-[11px] leading-5" style={{ color: "#667179" }}>
                Ready to connect to your existing backend auth later without changing the portal layout.
              </p>
            </div>
          </div>
            ...
            {mode === "login" && (
              <div>
                ...
                <div className="mt-5 grid gap-4">
                  ...
                  <button onClick={() => navigate("/account")} className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[#121517] px-5 text-[12px] font-bold text-white">
                    Sign in
            ...
            {mode === "forgot" && (
              <div>
                ...
                <div className="mt-5 grid gap-4">
                  ...
                  <button className="inline-flex h-11 items-center justify-center gap-2 rounded-full bg-[#121517] px-5 text-[12px] font-bold text-white">
                    Send reset link
                    <ChevronRight className="h-4 w-4" />
                  </button>
                </div>
